...
const Entrepreneurs = () => {
    return (
        <>
            <Head>
                <meta name="description" content="Radca Prawny Łukasz Szczepaniak Piaseczno spółka jawna spółka z oo zapłata faktury obsługa przedsiębiorcy" />
                ...
                <div style={{ fontFamily: "Roboto Condensed" }} className="flex flex-col sm:flex-row w-11/12 xl:w-9/12">
                    ...
                    <div className="sm:w-2/3 sm:ml-8 text-justify sm:text-left">
                        ...
                        <ul className="text-lg xl:text-xl mb-10">
                            ...
                            <li className="my-2 p-2 tracking-wide"><span className="text-blue-text">+ </span>udzielaniem bezpośrednich konsultacji telefonicznych</li>
                            <li className="my-2 p-2 tracking-wide"><span className="text-blue-text">+ </span>prowadzeniem spraw pracowniczych</li>
                        </ul>
                    </div>
                </div>
            </div>
